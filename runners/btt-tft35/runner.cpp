...
// commander_config()/commander_setup(); this owns main(), the clock, the USART2 console,
...
// (HSE crystal frequency, the status LED pin). No LCD/touch/SD support here yet; this
// only brings up a shell console over USART2 (the board's "RS232" header).
...
int main(void) {
    ...
    _uart.begin(_registry, _cfg.uart_baud, greeting);   // USART2
